<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="药品分类" prop="categoryName">
        <el-input
      ...
      <el-form-item label="是否处方药" prop="isPrescription">
        <el-select v-model="queryParams.isPrescription" placeholder="请选择" clearable style="width: 100px">
    ...
    <el-table v-loading="loading" :data="medicineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药品分类" align="center" prop="categoryName" width="100" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="药品分类" prop="categoryId">
          <el-select v-model="form.categoryId" placeholder="请选择药品分类" style="width: 100%">
            <el-option
...
<script>
import { listMedicine, getMedicine, delMedicine, addMedicine, updateMedicine } from "@/api/hospital/medicine/info"
import { listCategory } from "@/api/hospital/medicine/category"  // 导入分类查询方法
...
export default {
  ...
  created() {
    this.getList()
    this.getCategoryOptions(); // 获取分类下拉选项
  },
  methods: {
    /** 查询药品信息列表 */
    getList() {
    ...
    getCategoryOptions() {
      ...
      listCategory().then(response => {
        this.categoryOptions = response.data || response.rows || [];
      });
    },
    // 取消按钮
    cancel() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('hospital/medicine/export', {
        ...this.queryParams
