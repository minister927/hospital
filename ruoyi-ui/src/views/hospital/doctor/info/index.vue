...
<script>
import { listInfo, getInfo, delInfo, addInfo, updateInfo } from "@/api/hospital/doctor/info"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('doctor/info/export', {
        ...this.queryParams
